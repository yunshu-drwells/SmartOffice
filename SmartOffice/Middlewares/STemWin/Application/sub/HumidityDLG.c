...
extern uint16_t humidity;  //freertos.c
static uint8_t str[6] = {0};
// USER END
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { WINDOW_CreateIndirect, "Humidity", ID_WINDOW_0, 0, 0, 800, 480, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
	...
	//
	IMAGE_SetBitmap(hItem, &bmHumidity);
