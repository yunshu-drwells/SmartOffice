...
extern uint16_t temperature;  //freertos.c
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    TEXT_SetFont(hItem, &GUI_Fontfont);  // ËÆæÁΩÆÂ≠ó‰Ωì
    TEXT_SetText(hItem, "Ê∏©Â∫¶");
    TEXT_SetTextAlign(hItem, GUI_TA_HCENTER | GUI_TA_VCENTER);  // ËÆæÁΩÆÊñáÊú¨ÂØπÈΩêÊñπÂºèÔºàÂèØÈÄâÔºâ
    ...
    TEXT_SetText(hItem, (char*)str);
		...
		// ÂàõÂª∫Êõ¥Êñ∞‰ªªÂä°Ôºå‰º†ÈÄíTextÊéß‰ª∂Âè•ÊüÑ
  ...
  case WM_NOTIFY_PARENT:
    ...
    case ID_BUTTON_0: // Notifications sent by ''
      ...
      case WM_NOTIFICATION_RELEASED:
        // USER START (Optionally insert code for reacting on notification message)
        //∑µªÿ÷˜“≥
        GUI_EndDialog(pMsg->hWin, 0);  //Ω· ¯∂‘ª∞øÚ
        CreateWindowMain(); // ¥¥Ω®WindowMainΩÁ√Ê£¨µ˜”√∆‰À¸ΩÁ√ÊµƒCreate∑Ω∑®
				//ÈîÄÊØÅ‰ªªÂä°
				DeleteUpdateTask();
        // USER END
        break;
