...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { WINDOW_CreateIndirect, "Alarm", ID_WINDOW_0, 0, 0, 800, 480, 0, 0x0, 0 },
...
static void UpdateBitmapTask(void *pvParameters) {
	while(1){
		if(DoorOpened){
			...
			BUTTON_SetBitmap(hItem, BUTTON_BI_UNPRESSED, &bmLoRaOff);
			DoorOpened = 0;
		}
		vTaskDelay(pdMS_TO_TICKS(100));
	}
}
static void DeleteUpdateBitmapTask(void) {
    if (xUpdateBitmapTaskHandle != NULL) {
        vTaskDelete(xUpdateBitmapTaskHandle);
        xUpdateBitmapTaskHandle = NULL;
    }
}
// USER END
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
	...
	xTaskCreate(UpdateBitmapTask, "UpdateBitmapTask", 256, (void*)hItem, tskIDLE_PRIORITY + 1, &xUpdateBitmapTaskHandle);
...
*       CreateAlarm
*/
WM_HWIN CreateMagnetismLock(void);
WM_HWIN CreateMagnetismLock(void) {
  WM_HWIN hWin;
