 ...
 * 对于25Q128 FLASH芯片, 规定
 * 6MB后紧跟web相关文件
 * 10MB后紧�?18�?**.bin,总大�?762KB, 190个扇�?,被图库占用了,不能�?!
 * 12MB后紧�?3个字�?+UNIGBK.BIN+asc**.bin,总大�?3.11M, 791+5个扇�?,被字库占用了,不能�?!
 * 以及15.09M以后, 用户可以自由使用. 建议用最后的100K字节比较�?
 * 15.09M以后, 用户可以自由使用. 建议用最后的100K字节比较�?. 
 */
